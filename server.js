...
// Ruta de diagnóstico (Para saber si el servidor responde)
...
app.get('/movie/:id', async (req, res) => {
    ...
    try {
        ...
        // Intentar obtener magnet automático de YTS
        const magnet = req.query.magnet || await getAutoMagnet(movie.imdb_id) || '';
